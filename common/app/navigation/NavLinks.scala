...
// News
  val networkFront = NavLink2("", "/", "headlines", newsPillar, None, Some(NewsSections))
...
// Arts
  ...
  val culture = arts.copy(title = "culture home")
...
// Life
  ...
  val lifestyle = life.copy(title = "lifestyle home")
